...
public class GameJFrame_Diff extends JFrame implements MouseListener, ActionListener {

    int[][] data=new int[14][14];//0:无，1：有 ，-2，2：标记，3:4-10：数量  -1:显示所有雷,-3:点击的有雷区域
    int flag=0;
    int boom=30;//记录剩余雷数量
    ...
    private void InitImage() {
        ...
        jLableUp.setBounds(10,20,480,40);
        ...
        jLabelUpImg.setBounds(220,20,40,40);
        ...
        jLabelRecord.setBounds(340,20,80,40);
...
//            getContentPane().repaint();
    ...
    private void About(){
        ...
        jLabelImg.setBounds(85,30,350,74);
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(flag==1){//第一次点击后布雷，防止第一次点踩到雷
            Algorithm.initBoom(data,x+1,y+1,12,12,boom);
        }
        //标记
        if(record==1){
            FlagBoom(x+1,y+1);
        ...
        //判断是否有雷
        if(!Judge(x,y)){
            Algorithm.algorithm(data,x+1,y+1,12,12);
        }
        ResetImg();
    }
